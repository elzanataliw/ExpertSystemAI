...
;hasil dewasa dengan gejala diabetes
(defrule dewasagejalacepatriwayat1
	(umur3 yes)
	(gejala yes)
	(waktu yes)
	(riwayat yes)
	(BMI1 yes)
	=>
	(printout t crlf "Ingat! Anda memasuki usia rentan terkena diabetes dan saat ini Anda telah memiliki gejala diabetes,
 dengan berat badan yang kurang dan riwayat keluarga diabetes, segeralah cek ke dokter." crlf)
)

(defrule dewasagejalacepatriwayat2
	(umur3 yes)
	(gejala yes)
	(waktu yes)
	(riwayat yes)
	...
	=>
	(printout t crlf "Ingat! Anda memasuki usia rentan terkena diabetes dan saat ini Anda telah memiliki gejala diabetes,
 dengan riwayat keluarga diabetes, segeralah cek ke dokter." crlf)
)

(defrule dewasagejalacepatriwayat3
	(umur3 yes)
	(gejala yes)
	(waktu yes)
	(riwayat yes)
	...
	=>
	(printout t crlf "Ingat! Anda memasuki usia rentan terkena diabetes dan saat ini Anda telah memiliki gejala diabetes,
 dengan berat badan berlebih dan riwayat keluarga diabetes, segeralah cek ke dokter." crlf)
)

(defrule dewasagejalalamariwayat1
	(umur3 yes)
	(gejala yes)
	(waktu no)
	(riwayat yes)
	(BMI1 yes)
	=>
	(printout t crlf "Waspada! Anda memasuki usia rentan terkena diabetes, dengan berat badan yang kurang dan riwayat keluarga diabetes, 
Anda juga memiliki gejala diabetes dan memungkinkan terkena diabetes tipe 2, segeralah memulai
pola hidup sehat dan cek ke dokter untuk mendapatkan penanganan yang cepat." crlf)
)

(defrule dewasagejalalamariwayat2
	(umur3 yes)
	(gejala yes)
	(waktu no)
	(riwayat yes)
	(BMI2 yes)
	=>
	(printout t crlf "Waspada! Anda memasuki usia rentan terkena diabetes, dengan memiliki riwayat keluarga
diabetes, Anda juga memiliki gejala diabetes dan memungkinkan terkena diabetes tipe 2, segeralah 
memulai pola hidup sehat dan cek ke dokter untuk mendapatkan penanganan yang cepat." crlf)
)

(defrule dewasagejalalamariwayat3
	(umur3 yes)
	(gejala yes)
	(waktu no)
	(riwayat yes)
	(BMI3 yes)
	=>
	(printout t crlf "Waspada! Anda memasuki usia rentan terkena diabetes, dengan berat badan berlebih dan 
riwayat keluarga diabetes, Anda memiliki gejala diabetes dan memungkinkan terkena diabetes tipe 2, 
segeralah memulai pola hidup sehat dan  cek ke dokter untuk mendapatkan penanganan yang cepat." crlf)
)

(defrule dewasagejalacepat1
	(umur3 yes)
	(gejala yes)
	(waktu yes)
	(riwayat no)
	(BMI1 yes)
	=>
	(printout t crlf "Anda memasuki usia rentan terkena diabetes dan saat ini Anda telah memiliki gejala 
diabetes dengan berat badan yang kurang, disarankan untuk mengonsumsi makanan yang bergizi 
dan segeralah cek ke dokter." crlf)
)

(defrule dewasagejalacepat2
	(umur3 yes)
	(gejala yes)
	(waktu yes)
	(riwayat no)
	(BMI2 yes)
	=>
	(printout t crlf "Anda memasuki usia rentan terkena diabetes dan saat ini Anda telah memiliki gejala diabetes,
 disarankan untuk mengonsumsi makanan yang bergizi dan segeralah cek ke dokter." crlf)
)

(defrule dewasagejalacepat3
	(umur3 yes)
	(gejala yes)
	(waktu yes)
	(riwayat no)
	...
	=>
	(printout t crlf "Anda memasuki usia rentan terkena diabetes dan saat ini Anda telah memiliki gejala diabetes 
dengan berat badan berlebih memungkinkan Anda terkena diabetes tipe 2, disarankan untuk mengonsumsi 
makanan yang bergizi dan segeralah cek ke dokter." crlf)
)

(defrule dewasagejalalama1
	(umur3 yes)
	(gejala yes)
	(waktu no)
	(riwayat no)
	(BMI1 yes)
	=>
	(printout t crlf "Anda memasuki usia rentan terkena diabetes dan saat ini Anda memiliki gejala diabetes
dengan berat badan yang kurang memungkinkan Anda terkena diabetes tipe 2, segeralah 
memulai pola hidup sehat dan cek ke dokter untuk mendapatkan penanganan yang cepat." crlf)
)

(defrule dewasagejalalama2
	(umur3 yes)
	(gejala yes)
	(waktu no)
	(riwayat no)
	...
	=>
	(printout t crlf "Anda memasuki usia rentan terkena diabetes dan saat ini  Anda memiliki gejala diabetes 
yang memungkinkan Anda terkena diabetes tipe 2, segeralah memulai pola hidup sehat
 dan cek ke dokter untuk mendapatkan penanganan yang cepat." crlf)
)

(defrule dewasagejalalama3
	(umur3 yes)
	(gejala yes)
	(waktu no)
	(riwayat no)
	...
	=>
	(printout t crlf "Anda memasuki usia rentan terkena diabetes dan saat ini Anda memiliki gejala diabetes 
dengan berat badan berlebih, memungkinkan Anda terkena diabetes tipe 2, segeralah 
memulai pola hidup sehat dan cek ke dokter untuk mendapatkan penanganan yang cepat." crlf)
)


;hasil dewasa tanpa gejala diabetes
(defrule dewasariwayatnogejala1
	(umur3 yes)
	(gejala no)
	(riwayat yes)
	(BMI1 yes)
	=>
	(printout t crlf "Saat ini Anda berada pada usia rentan terkena diabetes, Anda memiliki berat badan 
yang kurang dan memiliki riwayat keluarga diabetes, disarankan untuk mengonsumsi makanan 
yang bergizi dan rutin berolahraga serta menaikkan berat badan Anda." crlf)
)

(defrule dewasariwayatnogejala2
	(umur3 yes)
	(gejala no)
	(riwayat yes)
	(BMI2 yes)
	=>
	(printout t crlf "Saat ini Anda berada pada usia rentan terkena diabetes, Anda memiliki berat 
badan yang idealdan memiliki riwayat keluarga diabetes, disarankan untuk
 mengonsumsi makanan yang bergizi dan rutin berolahraga." crlf)
)

(defrule dewasariwayatnogejala3
	(umur3 yes)
	(gejala no)
	(riwayat yes)
	(BMI3 yes)
	=>
	(printout t crlf "Saat ini Anda berada pada usia rentan terkena diabetes, Anda memiliki berat 
badan berlebih dan memiliki riwayat keluarga diabetes, disarankan untuk mengonsumsi 
makanan yang bergizi dan rutin berolahraga serta menurunkan berat badan Anda." crlf)
)

(defrule dewasanogejalariwayat1
	(umur2 yes)
	(gejala no)
	(riwayat no)
	(BMI1 yes)
	=>
	(printout t crlf "Pada usia yang cukup rentan terkena diabetes, Anda memiliki berat badan
 yang kurang, disarankan untuk mengonsumsi makanan yang bergizi dan rutin
 berolahraga serta menaikkan berat badan Anda." crlf)
)

(defrule dewasanogejalariwayat2
	(umur2 yes)
	(gejala no)
	(riwayat no)
	(BMI2 yes)
	=>
	(printout t crlf "Pada usia yang cukup rentan terkena diabetes, Anda memiliki berat 
badan yang ideal, tetap jaga kesehatan dengan mengonsumsi makanan 
yang bergizi dan rutin berolahraga." crlf)
)

(defrule dewasanogejalariwayat3
	(umur2 yes)
	(gejala no)
	(riwayat no)
	(BMI3 yes)
	=>
	(printout t crlf "Pada usia yang cukup rentan terkena diabetes, Anda memiliki berat
 badan berlebih, disarankan untuk mengonsumsi makanan yang
 bergizi dan rutin berolahraga serta menaikkan berat badan Anda." crlf)
)